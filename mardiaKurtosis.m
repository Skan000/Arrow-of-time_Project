function [mKurt, expKurt, deltaSkew, deltaKurt] = mardiaKurtosis(X)
% INPUT
...
D = dfm/COVm * dfm'; % squared Mahalonobis distance
...
deltaSkew=0;
%deltaSkew = abs(mSkew);             % gaussianity distance skewness
deltaKurt = abs(mKurt-expKurt);   % gaussianity distance kurtosis